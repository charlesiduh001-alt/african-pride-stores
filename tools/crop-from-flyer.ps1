...
#
# Each line is:  name, left, top, width, height
# measured in pixels on the original flyer, which is 853 wide by 1280 tall.
# The name decides the file name, so it must match the "image" field of the
# matching product in script.js.
